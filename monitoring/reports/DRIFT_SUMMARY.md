...
_Generated 2026-08-15 23:19_

Reference: clean training split. Clean baseline predicted-positive ratio: **0.257**.
...
|---|---|---|---|---|---|---|
| `column_swap` | 4/18 | 0.222 | False | 0.255 (+0.002) | 4_COLS_DRIFTED | [html](column_swap.html) |
| `dist_shift` | 5/18 | 0.278 | False | 0.953 (+0.696) | 5_COLS_DRIFTED, PRED_SHIFT_0.70 | [html](dist_shift.html) |
| `out_of_bounds` | 5/18 | 0.278 | False | 0.004 (+0.253) | 5_COLS_DRIFTED, PRED_SHIFT_0.25 | [html](out_of_bounds.html) |
| `schema_change` | 3/18 | 0.167 | False | 0.218 (+0.039) | 3_COLS_DRIFTED | [html](schema_change.html) |
